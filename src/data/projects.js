export const projects = [
  {
    id: 1,
    emoji: "🌿",
    name: "Kocayayla Kooperatifi",
    tags: ["React", "Vite", "Tailwind CSS", "Sanity CMS", "Netlify"],
    description: {
      tr: "Kocayayla Tarımsal Kalkınma Kooperatifi için sıfırdan tasarlayıp geliştirdiğim kurumsal web sitesi. Kurumsal bilgiler, faaliyetler, haberler, duyurular ve galeri bölümleri içeriyor.",
      en: "Corporate website built from scratch for Kocayayla Agricultural Cooperative. Includes institutional info, activities, news, announcements and gallery sections."
    },
    github: null,
    live: "https://kocayaylakooperatifi.org",
    color: "from-amber-50 to-orange-100"
  },
  {
    id: 2,
    emoji: "🌾",
    name: "Yaykın Kooperatifi",
    tags: ["React", "Vite", "Tailwind CSS", "Sanity CMS", "Cloudflare Pages"],
    description: {
      tr: "Kocayayla projesini temel alarak Yaykın Tarımsal Kalkınma Kooperatifi için geliştirdiğim kurumsal web sitesi. Özgün tasarım ve içeriklerle yeniden kimlik oluşturuldu.",
      en: "Corporate website developed for Yaykın Agricultural Cooperative, built on the Kocayayla codebase with a distinct brand identity and content."
    },
    github: null,
    live: "https://yaykinkooperatifi.org",
  ...
  },
  {
    ...
    github: "https://github.com/BegumEmir/pea-game",
    live: null,
  ...
  },
  {
    ...
    github: "https://github.com/senanurgumus/SmartLearningPlatform",
    live: null,
  ...
  },
  {
    ...
    github: "https://github.com/BegumEmir/begum-emir-qa",
    live: null,
